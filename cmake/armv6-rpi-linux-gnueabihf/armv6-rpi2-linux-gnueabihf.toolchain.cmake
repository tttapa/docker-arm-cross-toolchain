...
# Compiler flags
set(CMAKE_C_FLAGS_INIT       "-mtune=cortex-a7 -mfpu=vfp -mfloat-abi=hard")
set(CMAKE_CXX_FLAGS_INIT     "-mtune=cortex-a7 -mfpu=vfp -mfloat-abi=hard")
set(CMAKE_Fortran_FLAGS_INIT "-mtune=cortex-a7 -mfpu=vfp -mfloat-abi=hard")
