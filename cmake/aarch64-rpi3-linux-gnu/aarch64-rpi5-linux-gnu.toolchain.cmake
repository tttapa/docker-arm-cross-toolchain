...
# Compiler flags
set(CMAKE_C_FLAGS_INIT       "-mcpu=cortex-a76+crypto+crc+simd")
set(CMAKE_CXX_FLAGS_INIT     "-mcpu=cortex-a76+crypto+crc+simd")
set(CMAKE_Fortran_FLAGS_INIT "-mcpu=cortex-a76+crypto+crc+simd")
